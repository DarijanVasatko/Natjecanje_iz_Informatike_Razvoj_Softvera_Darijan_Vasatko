...
return new class extends Migration
{
    ...
    {
        // Ukloni stare foreign keys ako postoje
        ...
        // Promijeni tip kolone da odgovara users.id (bigint unsigned)
        DB::statement('ALTER TABLE kosarica MODIFY korisnik_id BIGINT UNSIGNED NOT NULL');

        // Obriši zapise koji nemaju odgovarajućeg korisnika u users tablici
        DB::statement('DELETE FROM kosarica WHERE korisnik_id NOT IN (SELECT id FROM users)');

        // Dodaj novi foreign key koji referencira users tablicu
